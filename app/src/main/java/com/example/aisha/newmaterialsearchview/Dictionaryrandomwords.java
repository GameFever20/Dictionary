...
public class Dictionaryrandomwords extends AsyncTask<Void, Void, String>  {
    ...
    protected void onPostExecute(String results) {
        ...
        callingmainpassingrandom(myrandomWordsArraylist);

    }

    public void callingmainpassingrandom(ArrayList<String> myrandomWordsArraylist ){

        mainActivityclass.listenandgetrandomword( myrandomWordsArraylist);
    }
}
